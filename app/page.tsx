          ...
          <aside className="w-full md:w-[45%] flex flex-col gap-4 md:min-h-0">
            ...
            <div className="bg-white border border-zinc-100 rounded-3xl p-2 shadow-sm flex items-center justify-between">
              <button
                ...
                className={`flex-1 flex justify-center items-center gap-2 py-2 rounded-2xl text-[11px] font-bold uppercase tracking-wider transition-all ${activeTab === 'logs' ? 'bg-black text-white' : 'text-zinc-400 hover:text-black'}`}
              >
                <ListFilter size={16} /> History
              </button>
              <button
                onClick={() => setActiveTab('charts')}
                className={`flex-1 flex justify-center items-center gap-2 py-2 rounded-2xl text-[11px] font-bold uppercase tracking-wider transition-all ${activeTab === 'charts' ? 'bg-black text-white' : 'text-zinc-400 hover:text-black'}`}
              >
