        ...
        <header className="mb-2 md:mb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-zinc-500 font-medium text-sm md:text-base italic">Track your progress, build your legacy.</p>
                </div>
            ...
            <div className="flex items-center gap-4 self-end sm:self-center">
                {user && (
                    <div className="flex flex-col items-end mr-2">
                        <span className="text-[10px] uppercase tracking-widest text-zinc-400 font-bold">Authenticated</span>
                        <div className="flex items-center gap-2">
                            <span className="text-sm font-bold text-black">Logged in as {user.name || user.email}</span>
